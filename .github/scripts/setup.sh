...
if [ ! -d "/home/actions" ]; then
    ...
    su -c "curl -o /home/actions/install_runner.sh https://raw.githubusercontent.com/Homebrew/actions/master/create-gcloud-instance/install_runner.sh" actions
    su -c "curl -o /home/actions/config_runner.sh https://raw.githubusercontent.com/Homebrew/actions/master/create-gcloud-instance/config_runner.sh" actions
